"""Youtube extraction and download classes."""
...
class YouTubeExtractor:
    ...
    def __init__(self):
        ...
        # Do a flat extraction to retrieve minimal data (titles, etc.)
    ...
    def download_audio_file(self, url: str) -> str:
        ...
        """
        # Let yt-dlp choose the correct extension (e.g. webm, m4a, opus).
